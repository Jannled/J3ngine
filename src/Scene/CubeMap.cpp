...
ShaderProgram* CubeMap::prefilterShader = NULL;
ShaderProgram* CubeMap::brdfShader = NULL;
...
GLuint CubeMap::getPrefilterMap()
{
	return prefilterMap;
}

GLuint CubeMap::getBRDFLUT()
{
	return brdfLUT;
}